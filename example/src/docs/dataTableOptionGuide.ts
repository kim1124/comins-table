...
export const dataTableOptionGuide: DataTableOptionGuideSource = [
  {
    items: [
      ...
      { description: defineLocalizedText("Flat Row를 하나 이상의 criterion Column으로 그룹화하고 controlled expansion과 내장 집계를 구성합니다. Pagination, Infinite/Lazy Loading, Tree Grid와 Row drag는 함께 사용할 수 없습니다.", "Groups flat rows by one or more criterion columns with controlled expansion and built-in aggregation. It cannot be combined with pagination, infinite/lazy loading, Tree Grid, or row drag."), name: "rowGrouping" },
    ],
  ...
  },
  {
    items: [
      ...
      { description: defineLocalizedText("Group disclosure가 전환된 뒤 다음 opaque Group ID 배열을 전달합니다. 생략하면 Group disclosure는 disabled read-only입니다.", "Receives the next opaque group ID array after a group disclosure is toggled. Omit it for disabled read-only group disclosure."), name: "rowGrouping.onChangeExpandedGroupIds" },
