...
export const dataTableOptionGuide = [
  {
    items: [
      ...
      { description: "Enables Shift+click and Shift+Enter/Space to build an ordered multi-column sort model. Defaults to false.", name: "multiSort" },
      { description: "Controlled owner business Row IDs whose semantic Detail regions are mounted.", name: "expandedRowIds" },
      { description: "Returns a finite positive fixed Detail height. Missing, invalid, and \"auto\" values use measured automatic height without inline height.", name: "getRowDetailHeight" },
      { description: "Estimate for an automatic Detail before matching-width measurement: a valid finite positive value wins; otherwise the resolved rowHeight is used.", name: "estimatedRowDetailHeight" },
  ...
  },
  {
    items: [
      ...
      { description: "Row grouping, pivoting, charts integration, and AI assistant are roadmap items.", name: "Advanced Feature Roadmap" },
    ],
    title: "Roadmap",
  },
];
