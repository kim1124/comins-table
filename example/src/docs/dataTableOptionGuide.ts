...
export const dataTableOptionGuide: DataTableOptionGuideSource = [
  ...
  },
  {
    items: [
      ...
      { description: defineLocalizedText("Offset, limit, reason과 AbortSignal을 받고 Lazy Row batch와 total을 반환합니다.", "Receives offset, limit, reason, and AbortSignal, then returns a lazy row batch and total."), name: "onLazyLoad" },
    ],
  ...
  },
  {
    items: [
      ...
      { description: defineLocalizedText("Row Grouping, Pivot, Chart 연동과 AI Assistant는 로드맵 항목입니다.", "Row grouping, pivoting, charts integration, and AI assistant are roadmap items."), name: "Advanced Feature Roadmap" },
    ],
