...
const themeOptions = [
  ...
  { className: "comins-table-theme--dark", label: "Dark", value: "dark" },
  { className: "comins-table-theme--skyblue", label: "Skyblue", value: "skyblue" },
  { className: "comins-table-theme--mint", label: "Mint", value: "mint" },
  { className: "comins-table-theme--gray", label: "Gray", value: "gray" },
  { className: "comins-table-theme--orange", label: "Orange", value: "orange" },
];

const rowHeight = 32;
const themeStyle = {
  "--comins-table-cell-height": `${rowHeight}px`,
  "--comins-table-row-height": `${rowHeight}px`,
