...
const currentReviewEntries = [
  { name: 'lightningcss', version: '1.33.0', license: 'MPL-2.0', dev: true },
  { name: 'lightningcss-android-arm64', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-darwin-arm64', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-darwin-x64', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-freebsd-x64', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-linux-arm-gnueabihf', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-linux-arm64-gnu', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-linux-arm64-musl', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-linux-x64-gnu', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-linux-x64-musl', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-win32-arm64-msvc', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
  { name: 'lightningcss-win32-x64-msvc', version: '1.33.0', license: 'MPL-2.0', dev: true, optional: true },
...
test('blocks the exact current non-automatic dependencies without approvals', () => {
  const expected = [
    'license-check: review required: lightningcss@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-android-arm64@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-darwin-arm64@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-darwin-x64@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-freebsd-x64@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-linux-arm-gnueabihf@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-linux-arm64-gnu@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-linux-arm64-musl@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-linux-x64-gnu@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-linux-x64-musl@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-win32-arm64-msvc@1.33.0 (MPL-2.0; development-only-tooling)',
    'license-check: review required: lightningcss-win32-x64-msvc@1.33.0 (MPL-2.0; development-only-tooling)',
